/*
 ...
 .
 .	$Revision: 1.340 $ $Date: 2010/12/08 20:41:57 $
 */
...
static char *cmd1v[NCMD] = {
    ...
    "add", "mul", "log10", "data", "bin_outline", "bintvls", "radar_lon",
...
static callback *cb1v[NCMD] = {
    ...
    add_cb, mul_cb, log10_cb, data_cb, bin_outline_cb, bintvls_cb, radar_lon_cb,
